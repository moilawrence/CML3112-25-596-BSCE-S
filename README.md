...
* **Student Registration Number:** 25/596/BSCE-S
...
* `CML3112_25_596_BSCE_S_W02.ipynb` - The primary verified execution notebook.
* `california_housing_train.csv` - The source dataset containing regional survey details.

## Run Instructions
1. Open the notebook file `CML3112_25_596_BSCE_S_W02.ipynb` in Google Colab.
